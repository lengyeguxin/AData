"""
stock_monthlyCollector - stock_monthly表拉取器模板
...
class StockmonthlyCollector(BaseCollector):
    ...
    def _extract_values(self, item: Dict) -> tuple:
        """
        提取字段值（严格按照stock_monthly_schema.sql定义，完整21个字段）
    ...
    def _build_insert_query(self) -> str:
        ...
        return f"""
            INSERT INTO stock_monthly (ts_code, trade_date, end_date, freq, open, high, low, close, pre_close, open_qfq, high_qfq, low_qfq, close_qfq, open_hfq, high_hfq, low_hfq, close_hfq, vol, amount, change, pct_chg, updated_at)
            VALUES ({placeholders})
