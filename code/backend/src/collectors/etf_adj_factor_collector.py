"""
ETFAdjFactorCollector - ETF复权因子拉取器
...
class ETFAdjFactorCollector(BaseCollector):
    ...
    def collect_by_date(self, trade_date: str) -> List[Dict]:
        ...
        示例：
            collect_by_date('20260409') → 拉取2026-04-09所有ETF复权因子
        """
        self.logger.info(f"拉取ETF复权因子: trade_date={trade_date}")
    ...
    def _extract_values(self, item: Dict) -> tuple:
        ...
        return (
            ...
            item.get('adj_factor'),     # adj_factor
        )
