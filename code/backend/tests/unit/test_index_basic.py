...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "index_basic.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "index_basic"
    assert collector.api_name == "index_basic"

    print(f"✅ IndexBasicCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("index_basic表Collector单元测试")
    print("=" * 80)
