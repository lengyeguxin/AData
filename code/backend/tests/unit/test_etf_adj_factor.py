...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "etf_adj_factor.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "etf_adj_factor"
    assert collector.api_name == "fund_adj"

    print(f"✅ ETFAdjFactorCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("etf_adj_factor表Collector单元测试")
    print("=" * 80)
