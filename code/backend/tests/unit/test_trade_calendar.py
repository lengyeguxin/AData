...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "trade_calendar.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "trade_calendar"
    assert collector.api_name == "trade_cal"

    print(f"✅ TradeCalendarCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("trade_calendar表Collector单元测试")
    print("=" * 80)
