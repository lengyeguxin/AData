"""
hots_trader_detail表Collector单元测试
...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "hots_trader_detail.json"
...
if __name__ == "__main__":
    print("=" * 80)
    print("hots_trader_detail表Collector单元测试")
    print("=" * 80)
