...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "etf_basic.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "etf_basic"
    assert collector.api_name == "etf_basic"

    print(f"✅ ETFBasicCollector初始化测试通过")
