...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "ths_index_daily.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "ths_index_daily"
    assert collector.api_name == "ths_daily"

    print(f"✅ THSIndexDailyCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("ths_index_daily表Collector单元测试")
    print("=" * 80)
