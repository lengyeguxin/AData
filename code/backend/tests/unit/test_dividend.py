...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "dividend.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "dividend"
    assert collector.api_name == "dividend"

    print(f"✅ DividendCollector初始化测试通过")
