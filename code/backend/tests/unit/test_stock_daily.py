...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "stock_daily.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "stock_daily"
    assert collector.api_name == "daily"

    print(f"✅ DailyCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("stock_daily表Collector单元测试")
    print("=" * 80)
