"""
ths_concept_moneyflow表Collector单元测试
...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "ths_concept_moneyflow.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "ths_concept_moneyflow"
    assert collector.api_name == "moneyflow_cnt_ths"

    print(f"✅ THSConceptMoneyflowCollector初始化测试通过")
...
if __name__ == "__main__":
    print("=" * 80)
    print("ths_concept_moneyflow表Collector单元测试")
    print("=" * 80)
