...
# Mock数据
mock_data_file = Path(__file__).parent.parent.parent.parent.parent / "tests" / "mock_data" / "etf_index.json"
...
def test_collector_init():
    ...
    assert collector.table_name == "etf_index"
    assert collector.api_name == "etf_index"

    print(f"✅ ETFIndexCollector初始化测试通过")
